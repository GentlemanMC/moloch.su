...
public class Help extends Command {
    ...
    public void onCall(String s, String[] args) {
        ChatUtil.printChatMessage("\247b" + GlobalManagers.INSTANCE.clientName.getValue() + " " + "\247a" + GlobalManagers.INSTANCE.clientVersion);
        ...
        ChatUtil.printChatMessage("\2473" + "Use command: " + "\2479" + GlobalManagers.INSTANCE.clientPrefix.getValue() + "prefix <target prefix>" + "\2473" + " to set command prefix");
        ChatUtil.printChatMessage("\2473" + "List all available commands: " + "\2479" + GlobalManagers.INSTANCE.clientPrefix.getValue() + "commands");
    }
