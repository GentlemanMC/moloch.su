...
public class NumberSlider extends Component {
    ...
    public void render(int mouseX, int mouseY, float translateDelta, float partialTicks) {
        ...
        int numSliderTextColorColorDropMenuAnimateAlpha = (int)((ClickGUI.instance.numSliderTextColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1);
        if (numSliderTextColorColorDropMenuAnimateAlpha <= 4) {
            numSliderTextColorColorDropMenuAnimateAlpha = 4;
        }
        int numSliderDisplayValueTextColorColorDropMenuAnimateAlpha = (int)((ClickGUI.instance.numSliderDisplayValueTextColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1);
        ...
        if (ClickGUI.instance.numSliderThinMode.getValue()) {
            ...
            if (ClickGUI.instance.numSliderGradient.getValue()) {
                int slidedColorRight = isColorPanel ? (new Color(ClickGUI.instance.numSliderRightColor.getValue().getColorColor().getRed(), ClickGUI.instance.numSliderRightColor.getValue().getColorColor().getGreen(), ClickGUI.instance.numSliderRightColor.getValue().getColorColor().getBlue(), ClickGUI.instance.colorDropMenuAnimate.getValue() ? (int)((ClickGUI.instance.numSliderRightColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1) : ClickGUI.instance.numSliderRightColor.getValue().getAlpha()).getRGB()) : ClickGUI.instance.numSliderRightColor.getValue().getColor();
                int slidedColorLeft = isColorPanel ? (new Color(ClickGUI.instance.numSliderLeftColor.getValue().getColorColor().getRed(), ClickGUI.instance.numSliderLeftColor.getValue().getColorColor().getGreen(), ClickGUI.instance.numSliderLeftColor.getValue().getColorColor().getBlue(), ClickGUI.instance.colorDropMenuAnimate.getValue() ? (int)((ClickGUI.instance.numSliderLeftColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1) : ClickGUI.instance.numSliderLeftColor.getValue().getAlpha()).getRGB()) : ClickGUI.instance.numSliderLeftColor.getValue().getColor();
            ...
            if (ClickGUI.instance.numSliderThinModeSliderButton.getValue()) {
                int buttonShadowAlpha = isColorPanel ? (ClickGUI.instance.colorDropMenuAnimate.getValue() ? (int)((ClickGUI.instance.numSliderThinModeSliderButtonShadowAlpha.getValue() / 300.0f) * colorMenuToggleThreader1) : ClickGUI.instance.numSliderThinModeSliderButtonShadowAlpha.getValue()) : ClickGUI.instance.numSliderThinModeSliderButtonShadowAlpha.getValue();
                ...
                int numSliderThinModeSliderButtonColor = isColorPanel ? (new Color(ClickGUI.instance.numSliderThinModeSliderButtonColor.getValue().getColorColor().getRed(), ClickGUI.instance.numSliderThinModeSliderButtonColor.getValue().getColorColor().getGreen(), ClickGUI.instance.numSliderThinModeSliderButtonColor.getValue().getColorColor().getBlue(), ClickGUI.instance.colorDropMenuAnimate.getValue() ? (int)((ClickGUI.instance.numSliderThinModeSliderButtonColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1) : ClickGUI.instance.numSliderThinModeSliderButtonColor.getValue().getAlpha()).getRGB()) : ClickGUI.instance.numSliderThinModeSliderButtonColor.getValue().getColor();
    ...
    public void bottomRender(int mouseX, int mouseY, boolean lastSetting, boolean firstSetting, float partialTicks) {
        ...
        renderHoverRect(moduleName + setting.getName(), mouseX, mouseY, x, y, x + width, y + height, 2.0f, -5.0f, false);
    ...
    public boolean isHovered(int mouseX, int mouseY, float startX, float startY, float endX, float endY) {
        return RenderUtils2D.isMouseInRect(mouseX, mouseY, startX, startY, endX, endY - 1)
                && (!anyExpanded || isColorPanel || !RenderUtils2D.isMouseInRect(mouseX, mouseY, expandedX, expandedY, expandedEndX, expandedEndY))
