...
public class BooleanButton extends Component {
    ...
    public void render(int mouseX, int mouseY, float translateDelta, float partialTicks) {
        ...
        int booleanTextColorDisabledColorColorDropMenuAnimateAlpha = (int)((ClickGUI.instance.booleanTextColorDisabledColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1);
        if (booleanTextColorDisabledColorColorDropMenuAnimateAlpha <= 4) {
            booleanTextColorDisabledColorColorDropMenuAnimateAlpha = 4;
        }
        int defaultTextColorColorDropMenuAnimateAlpha = (int)((255 / 300.0f) * colorMenuToggleThreader1);
        ...
        booleanColor = isColorPanel ? (new Color(ClickGUI.instance.booleanColor.getValue().getColorColor().getRed(), ClickGUI.instance.booleanColor.getValue().getColorColor().getGreen(), ClickGUI.instance.booleanColor.getValue().getColorColor().getBlue(), ClickGUI.instance.colorDropMenuAnimate.getValue() ? (int)((ClickGUI.instance.booleanColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1) : ClickGUI.instance.booleanColor.getValue().getAlpha()).getRGB()) : ClickGUI.instance.booleanColor.getValue().getColor();
        ...
        if (ClickGUI.instance.booleanTextColorChange.getValue()) {
            int booleanTextColorEnabledColorColorDropMenuAnimateAlpha = (int)((ClickGUI.instance.booleanTextColorEnabledColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1);
        ...
        if (ClickGUI.instance.booleanFullRect.getValue()) {
            Color booleanFullRectColor = isColorPanel ? (new Color(ClickGUI.instance.booleanFullRectColor.getValue().getColorColor().getRed(), ClickGUI.instance.booleanFullRectColor.getValue().getColorColor().getGreen(), ClickGUI.instance.booleanFullRectColor.getValue().getColorColor().getBlue(), ClickGUI.instance.colorDropMenuAnimate.getValue() ? (int)((ClickGUI.instance.booleanFullRectColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1) : ClickGUI.instance.booleanFullRectColor.getValue().getAlpha())) : new Color(ClickGUI.instance.booleanFullRectColor.getValue().getColor());
        ...
        if (ClickGUI.instance.booleanSwitchType.getValue() != ClickGUI.BooleanSwitchTypes.None) {
            if (ClickGUI.instance.booleanSwitchColorChange.getValue()) {
                ...
                booleanDisabledColor = isColorPanel ? (new Color(ClickGUI.instance.booleanDisabledColor.getValue().getColorColor().getRed(), ClickGUI.instance.booleanDisabledColor.getValue().getColorColor().getGreen(), ClickGUI.instance.booleanDisabledColor.getValue().getColorColor().getBlue(), ClickGUI.instance.colorDropMenuAnimate.getValue() ? (int)((ClickGUI.instance.booleanDisabledColor.getValue().getAlpha() / 300.0f) * colorMenuToggleThreader1) : ClickGUI.instance.booleanDisabledColor.getValue().getAlpha())) : new Color(ClickGUI.instance.booleanDisabledColor.getValue().getColor());
