...
//TODO: impl repeat unit update block like in CrystalActionRender
...
public class HoveredHighlight extends Module {
    ...
    Setting<Color> solidColor = setting("SolidColor", new Color(new java.awt.Color(255, 255, 255, 20).getRGB())).whenTrue(solid);
    Setting<Boolean> lines = setting("Lines", true);
    Setting<Float> linesWidth = setting("LinesWidth", 1.0f, 1.0f, 5.0f).whenTrue(lines);
    Setting<Color> linesColor = setting("LinesColor", new Color(new java.awt.Color(255, 255, 255, 175).getRGB())).whenTrue(lines);
