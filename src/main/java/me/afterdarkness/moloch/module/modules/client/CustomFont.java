...
public class CustomFont extends Module {
    ...
    public Setting<Float> moduleTextOffsetX = setting("TextOffsetX", 0.0f, 0.0f, 50.0f).des("Module Name X Offset").whenAtMode(page, Page.EverythingElse);
    public Setting<Float> textOffset = setting("TextOffsetY", -1.0f, -13.0f, 13.0f).des("Module Name Y Offset").whenAtMode(page, Page.EverythingElse);
    ...
    public Setting<Color> moduleTextColor = setting("ModuleTextColor", new Color(new java.awt.Color(86, 86, 86, 206).getRGB())).des("Module Text Color").whenAtMode(page, Page.EverythingElse);
    ...
    public Setting<Color> categoryTextColor = setting("CategoryTextColor", new Color(new java.awt.Color(255, 255, 255, 255).getRGB())).des("Category Text Color").whenAtMode(page, Page.CategoryText);
