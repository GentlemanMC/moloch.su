...
public class Particles extends Module {
    ...
    public Setting<Float> maxParticleSpinSpeed = setting("MaxSpinSpeed", 3.5f, 0.0f, 5.0f).des("Max particles spin speed").when(() -> particlesShape.getValue() != ParticlesShape.Circle).whenAtMode(page, Page.Particles).whenAtMode(particlesPage, ParticlesPage.Particles);
    public Setting<Float> minParticleSpinSpeed = setting("MinSpinSpeed", 1.0f, 0.0f, 5.0f).des("Min particles spin speed").when(() -> particlesShape.getValue() != ParticlesShape.Circle).whenAtMode(page, Page.Particles).whenAtMode(particlesPage, ParticlesPage.Particles);
    ...
    public Setting<Color> particleRollColor1 = setting("ParticleRollColor1", new Color(new java.awt.Color(81, 43, 170, 204).getRGB())).whenTrue(particleRollColor).whenAtMode(page, Page.Particles).whenAtMode(particlesPage, ParticlesPage.Particles);
    public Setting<Color> particleRollColor2 = setting("ParticleRollColor2", new Color(new java.awt.Color(216, 180, 255, 204).getRGB())).whenTrue(particleRollColor).whenAtMode(page, Page.Particles).whenAtMode(particlesPage, ParticlesPage.Particles);
    ...
    public Setting<Color> particleColor = setting("ParticleColor", new Color(new java.awt.Color(255, 255, 255, 199).getRGB())).des("Particle Color").whenFalse(particleRollColor).whenAtMode(page, Page.Particles).whenAtMode(particlesPage, ParticlesPage.Particles);
    public Setting<Boolean> particleRainbowRoll = setting("ParticleRainbowRoll", true).des("Rolling particles rainbow").whenFalse(particleRollColor).when(() -> particleColor.getValue().getRainbow()).whenAtMode(page, Page.Particles).whenAtMode(particlesPage, ParticlesPage.Particles);
    public Setting<Float> particleRainbowRollSize = setting("PRainbowRollSize", 1.0f, 0.1f, 2.0f).des("Size of particle rainbow roll").whenTrue(particleRainbowRoll).whenFalse(particleRollColor).when(() -> particleColor.getValue().getRainbow()).whenAtMode(page, Page.Particles).whenAtMode(particlesPage, ParticlesPage.Particles);
    ...
    public Setting<Color> lineRollColor1 = setting("LineRollColor1", new Color(new java.awt.Color(81, 43, 170, 40).getRGB())).whenTrue(lineRollColor).whenAtMode(page, Page.Lines);
    public Setting<Color> lineRollColor2 = setting("LineRollColor2", new Color(new java.awt.Color(216, 180, 255, 40).getRGB())).whenTrue(lineRollColor).whenAtMode(page, Page.Lines);
    ...
    public Setting<Color> lineColor = setting("LineColor", new Color(new java.awt.Color(255, 255, 255, 40).getRGB())).des("Lines Color").whenFalse(lineRollColor).whenAtMode(page, Page.Lines);
    public Setting<Boolean> lineRainbowRoll = setting("LineRainbowRoll", true).des("Rolling lines rainbow").whenFalse(lineRollColor).when(() -> lineColor.getValue().getRainbow()).whenAtMode(page, Page.Lines);
    public Setting<Float> lineRainbowRollSize = setting("LRainbowRollSize", 1.0f, 0.1f, 2.0f).des("Size of line rainbow roll").whenTrue(lineRainbowRoll).whenFalse(lineRollColor).when(() -> lineColor.getValue().getRainbow()).whenAtMode(page, Page.Lines);
    ...
    private void doParticles(boolean chatMode) {
        if (!(mc.currentScreen instanceof ClickGUIFinal || mc.currentScreen instanceof HUDEditorFinal)) {
            ...
            if (!isOtherGUIOpen() && !mc.ingameGUI.getChatGUI().getChatOpen()) {
                ParticleUtil.particlesClearTask.invokeLock();
            }
        }
    }
