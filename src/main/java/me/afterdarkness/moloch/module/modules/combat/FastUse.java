...
public class FastUse extends Module {
    ...
    Setting<Boolean> xp = setting("Xp", false).des("Modify throwing experience bottle delay").when(() -> ModuleManager.getModule(XPPlus.class).isDisabled());
    Setting<Integer> xpDelay = setting("XpDelay", 0, 0, 10).des("Delay of throwing experience bottle").when(() -> ModuleManager.getModule(XPPlus.class).isDisabled()).whenTrue(xp);
